...
@if($errors->any())
	<div class="form-group {{ $errors->has('password_confiramtion') ? 'has-error' : 'has-success' }}">
@else
	<div class="form-group">
@endif
	{!! Form::label('password_confiramtion', 'Password Confirmation:', ['class' => 'control-label']) !!}	
	{!! Form::password('password_confiramtion', ['class' => 'form-control']) !!}	
	@if($errors->has('password_confiramtion'))
	<span class="help-block">{{ $errors->first('password_confiramtion') }}</span>
	@endif	
</div>
